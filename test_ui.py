...
def test_hotels():
    ...
    driver.find_element(By.CSS_SELECTOR, '[href="/searchhotel"]').click()

    hotel_box = driver.find_element(By.CSS_SELECTOR, '[class="links__link link-active"]').is_displayed()

    assert hotel_box == True
